...
Boolean IsValidAmazonS3Key(const char* pszKey);
Boolean IsValidAmazonS3KeyStr(NSString* strKey);

Boolean IsValidAmazonS3BucketName(const char* pszBucketName);
Boolean IsValidAmazonS3BucketNameStr(NSString* strBucketName) ;
